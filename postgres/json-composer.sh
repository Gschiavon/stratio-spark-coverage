...
cat << EOF > postgres/body.json
{
    ...
    "sparkProperties": {
        ...
        "spark.mesos.driverEnv.SPARK_SECURITY_DATASTORE_VAULT_CERT_PATH": "/v1/userland/certificates/spark-postgrestest",
        ...
        "spark.executorEnv.SPARK_SECURITY_DATASTORE_VAULT_CERT_PATH": "/v1/userland/certificates/spark-postgrestest",
