...
HDFS_STRATIO="hdfs://<HDFS_STRATIO_URL>:<HDFS_STRATIO_PORT>" ## PF --> hdfs://10.200.0.74:8020 || PNF --> hdfs://stratio:8020
TEST_ARTIFACTS_VERSION="0.1.0-SNAPSHOT"


#POSTGRES CONF VARS
PG_HOST="pg-0001-<POSTGRES_TLS_INSTANCE_NAME>.service.paas.labs.stratio.com" ## postgrestls
PG_PORT="5432"
